  ...
  return {
    ...
    batches: [
      makeBatch(day),
      {
        ...
        stocked: 1000, alive: 990, totalDeaths: 10, totalFeed: 250,
        costPerBird: 1240, fcr: 1.32, mortPct: 1.0, status: "ahead",
      },
      {
        id: "b-tiny", name: "Batch D", breed: "Arbor Acres", type: "broiler", day: Math.min(2, day),
        stocked: 300, alive: 293, totalDeaths: 7, totalFeed: 9,
        costPerBird: 870, fcr: null, mortPct: 2.3, status: "on-track",
      },
    ],
  };
}
